    ...
    <div class="app-container container-xxl py-4">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 order-2 order-lg-1">
                <div class="eyebrow mb-3">About Flashcards</div>
                <h2 class="fw-bold text-teal-deep mb-3" style="font-size:clamp(1.9rem,3.5vw,2.75rem);letter-spacing:-.025em;line-height:1.15;">
                    A reviewer system built for how you actually study
                </h2>
                <p class="text-slate lh-lg mb-4">
                    Flashcards is a technical reviewer system that lets you create study decks manually or in bulk, then walk through the material in the way that works best for you — whether that's a casual flip-through, a quick quiz, or a full-length exam simulation.
                </p>

                <!-- process cards -->
                <div class="process-card d-flex align-items-start gap-3 p-4 rounded-3 border mb-3">
                    <div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0 bg-teal-light text-teal" style="width:46px;height:46px;font-size:1.2rem;">
                        <i class="bi bi-file-earmark-text"></i>
                    </div>
                    <div>
                        <div class="text-slate fw-bold mb-1" style="font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;">Creation</div>
                        <div class="fw-bold text-teal-deep mb-1">Build your deck your way</div>
                        <p class="text-slate mb-0 small lh-base">Fill in cards one by one using a simple form, or import your entire deck at once using a <strong>.csv</strong> file for instant setup.</p>
                    </div>
                </div>

                <div class="process-card d-flex align-items-start gap-3 p-4 rounded-3 border mb-3">
                    <div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0" style="width:46px;height:46px;font-size:1.2rem;background:#FFF7ED;color:#EA580C;">
                        <i class="bi bi-layers-half"></i>
                    </div>
                    <div>
                        <div class="text-slate fw-bold mb-1" style="font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;">Study</div>
                        <div class="fw-bold text-teal-deep mb-1">Three modes, one goal</div>
                        <p class="text-slate mb-0 small lh-base">Review with <strong>Learn</strong>, check yourself with <strong>Practice</strong>, and prove mastery with the full <strong>Test</strong> — structured progression from exposure to validation.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="position-relative">
                    <div class="deck-mockup bg-teal-light border p-4" style="border-color:#C5E9E7 !important;">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-4">
                            ...
                            <span class="deck-dot" style="background:#FBBF24;"></span>
                            <span class="deck-dot" style="background:#34D399;"></span>
                    ...
                    <div class="position-absolute d-flex align-items-center gap-3 rounded-3 p-3 shadow-lg bg-teal-deep text-white"
                        ...
                        <div>
                            deck_network.csv imported
                            <span class="d-block opacity-50" style="font-size:.68rem;font-weight:400;">24 flashcards added instantly</span>
                        </div>
                    </div>
                </div>
            </div>
