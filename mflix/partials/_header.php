<div id="kt_app_header" class="app-header bg-white" data-kt-sticky="true"
  ...
  <div class="app-container container-xxl d-flex align-items-stretch justify-content-between"
    ...
    <div class="app-navbar flex-shrink-0">
      ...
      <a href="/mflix/" onclick="KTApp.showPageLoading()" class="d-flex align-items-center">
        <h1 class="mb-0">
          <img src="/assets/img/logo/logo-mflix.svg" alt="M-Flix Logo" class="h-30px">
          <span class="d-none">M-Flix</span>
        </h1>
      </a>
    </div>
      ...
      <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
        ...
        <div
          ...
          <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
            <a href="/mflix/discover" onclick="KTApp.showPageLoading()" class="menu-link text-hover-mflix">
              <span class="menu-title">Discover</span>
            </a>
          </div>

          <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
            <a href="/mflix/courses" onclick="KTApp.showPageLoading()" class="menu-link text-hover-mflix">
              <span class="menu-title">Courses</span>
            </a>
          </div>

          <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
            <a href="/leaderboard/view/mflix" onclick="KTApp.showPageLoading()" class="menu-link text-hover-mflix">
