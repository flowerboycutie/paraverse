    ...
    <div class="card-header border-0 pt-10">
      <div class="row w-100">
        ...
        <div class="col-lg-8 col-md-7 text-md-end">
          <a href="/mflix/admin/courses/manage" class="btn btn-mflix fw-bold" onclick="KTApp.showPageLoading()">
            <i class="bi bi-plus fs-2 text-white"></i>Add Course
          </a>
        </div>
      </div>
    </div>
    ...
    var MBGDATATABLE = $('#EdITH-TABLE').DataTable({
      ...
      "columnDefs": [
        ...
        },
        {
          ...
          "orderable": false,
          render: function (data, type, row) {
            let statusClass = row[3] === 'published' ? 'badge-light-success' : 'badge-light-warning';
            return `<span class="badge ${statusClass}">${row[3]}</span>`;
          }
        },
        {
          "targets": 4,
              ...
              <div>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-auto min-w-200 mw-300px py-3" data-kt-menu="true">
                  <div class="menu-item px-3">
                    <a href="/mflix/course/${row[4]}" class="menu-link px-3" target="_blank">
                      <i class="bi bi-eye me-2"></i>View
                    </a>
                  </div>
                  <div class="menu-item px-3">
                    <a href="/mflix/admin/courses/manage/${row[4]}" class="menu-link px-3" onclick="KTApp.showPageLoading()">
                      <i class="bi bi-pencil-square me-2"></i>Edit
                    </a>
                  </div>
                  <div class="menu-item px-3">
                    <a href="javascript:void(0)" id="${row[0]}" class="menu-link px-3 menu-delete" table="mflix_courses">
